 ...
 * 批量保存优惠券信息
 */
export function saveListBatch(data:any) {
  return defHttp.post<Result>({
    url: '/order/saveCouponListBatch',
    data: { data },
  })
}
 ...
 * 批量修改分组数据
 */
export function batchEditByGroup(params) {
  return defHttp.post<Result>({
    url: '/order/batchEditByGroupCoupon',
    data: params,
  })
}
