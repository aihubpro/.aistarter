<template>
  <div>
    ...
    <AIProjectViewModal @register="registerView" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  import { page,delAiProject,setProjectState } from './AIProject.api'
  import { useModal } from '/@/components/Modal';
  import EditMoreDesc from './EditMoreDesc.vue'
  import AIProjectViewModal from './AIProjectViewModal.vue'
  ...
  function setState(record, state){
    setProjectState({id:record.id, state}).then(() => {
